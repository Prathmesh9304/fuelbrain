        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-slate-500 max-w-sm leading-relaxed">
              Empowering children aged 8-16 with robust cognitive, analytical, and problem-solving skills through gamified education.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium">
              ...
              <li><Link to="/services" className="hover:text-brand-orange transition-colors">Our Programs</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500 font-medium">
              <li className="flex items-center gap-3"><Phone size={16} className="text-brand-blue" /> +91 98765 43210</li>
              <li className="flex items-center gap-3"><Mail size={16} className="text-brand-blue" /> info@fuelbrain.com</li>
              <li className="flex items-start gap-3"><MapPin size={16} className="mt-0.5 shrink-0 text-brand-blue" /> 123 Education Hub, Learning City, BK 400001</li>
            </ul>
          </div>
        </div>
